...
class PurchesViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func referralClickAction(_ sender: Any) {
        ...
        // text to share
        let text = "Hey, your friend \(AppConstant.shared.loggedUser.name) has recommended you to sign-up on Spinal Implant Database application by using code \(AppConstant.shared.loggedUser.referralCode). To download app: https://apps.apple.com/app/id1495178725"
