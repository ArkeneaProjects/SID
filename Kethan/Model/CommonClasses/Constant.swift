...
struct SubscriptionPlans {
    static var Monthly = "com.sid.monthly"
    static var AnnuallyFull = "com.kethan.50"
}
...
struct STATICDATA {
    ...
    static let arrUserGuide = [["image": "step1", "title": "Leverage Artificial Intelligence", "subtitle": "Simply click a picture of the spinal implant, or upload one from your gallery. Our system will then reveal what it believes to be the implant in question."],
                               ...
                               ["image": "step3", "title": "Add Information", "subtitle": "Have something useful for our system to learn? Hit the upload button with your image, and required information (manufacturer and brand), to win credits."],
