...
open class SkyFloatingLabelTextField: UITextField { 
    ...
    @IBInspectable var autoPlaceHolderFont: Bool = false
    ...
    fileprivate func updatePlaceholder() {
        ...
        let finalFont = autoPlaceHolderFont ? UIFont(name: font.fontName, size: getCalculated(placeHolderFontSize))! : font
        self.font = finalFont
            ...
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [
                    NSAttributedString.Key.foregroundColor: color, NSAttributedString.Key.font: finalFont
                ]
            )
        #elseif swift(>=4.0)
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [
                    NSAttributedStringKey.foregroundColor: color, NSAttributedStringKey.font: finalFont
                ]
            )
        #else
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [NSForegroundColorAttributeName: color, NSFontAttributeName: finalFont]
            )
        #endif
    }

    @IBInspectable var autoTitleFont: Bool = false
    @IBInspectable var titleFontSize: CGFloat = 0 {
        didSet {
            updateTitleLabel()
        }
    }
    ...
    */
    ...
    fileprivate func updateTitleLabel(_ animated: Bool = false) {
        ...
        let fontName = titleFont.fontName
        titleLabel.font = (autoTitleFont) ?UIFont(name: "\(fontName)-Medium", size: getCalculated(titleFontSize))! : titleFont
    ...
    */
    ...
    func addDoneButton(target: UIViewController, selector: Selector) {
        ...
        toolbar.barTintColor = UIColor(red: 218.0, green: 33.0, blue: 40.0, alpha: 1.0)
